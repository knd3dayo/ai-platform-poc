...
- [技術課題と対応方針](../02_アーキテクチャ実現方式/技術課題と対応方針.md): Proxy 許可リスト運用、ワークスペース分離、サンドボックス化の実装課題整理

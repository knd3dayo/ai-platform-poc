...
* 詳細：[02_AIエージェントの業務適用を見据えた生成AIガバナンス層の検討.md](./02_AI%E3%82%A8%E3%83%BC%E3%82%B8%E3%82%A7%E3%83%B3%E3%83%88%E3%81%AE%E6%A5%AD%E5%8B%99%E9%81%A9%E7%94%A8%E3%82%92%E8%A6%8B%E6%8D%AE%E3%81%88%E3%81%9F%E7%94%9F%E6%88%90AI%E3%82%AC%E3%83%90%E3%83%8A%E3%83%B3%E3%82%B9%E5%B1%A4%E3%81%AE%E6%A4%9C%E8%A8%8E.md)
...
* **2. AIガバナンス層（免疫・関所）**
Application層から外界へのすべての通信（LLM推論やツール実行）に強制的に介在し、個人情報のマスキング、監査ログの取得、ポリシー違反の遮断を行います。加えて、`trace_id` を主軸とした Observability、評価、コスト監視、停止判断といった横断的な統制能力もこの層の一部として扱います。
* **3. Tool層（手足・感覚器官）**
...
本書は Why / What / 責務原則を扱う総覧として位置づけ、コンポーネント配置と実装・運用原則は実現方式文書へ分離します。

* **コンポーネント配置と実装・運用原則**： [../02_アーキテクチャ実現方式/00_生成AI基盤のコンポーネント配置と実装・運用原則.md](../02_アーキテクチャ実現方式/00_生成AI基盤のコンポーネント配置と実装・運用原則.md)
* **業務適用例（カスタマーサポート）/ 検証シナリオ**： [../03_PoC検討/検証シナリオ.md](../03_PoC検討/検証シナリオ.md)

各層別ドキュメントに含まれる How の記述についても、今後は [../02_アーキテクチャ実現方式](../02_アーキテクチャ実現方式) 配下へ順次移し、[../01_アーキテクチャ検討](../01_アーキテクチャ検討) 配下は Why / What と責務分界の説明に寄せていきます。
